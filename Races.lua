...
local races = {
    ...
    { -- Breakneck Bolt Basic
        currencyID = 3181,
        uiMapID = 2346,
        areaPoiID = 8177,
        difficultyID = Difficulty.Basic,
        rankTimers = { 35000, 40000, },
    },
    { -- Breakneck Bolt Reverse
        currencyID = 3182,
        uiMapID = 2346,
        areaPoiID = 8177,
        difficultyID = Difficulty.Reverse,
    ...
    { -- Casino Cruise Basic
        ...
        areaPoiID = 8179,
        difficultyID = Difficulty.Basic,
        rankTimers = { 30000, 35000, },
    },
    { -- Casino Cruise Reverse
        currencyID = 3186,
        uiMapID = 2346,
        areaPoiID = 8179,
        difficultyID = Difficulty.Reverse,
    ...
    { -- Rags to Riches Rush Basic
        currencyID = 3126,
        uiMapID = 2346,
        areaPoiID = 8147,
        difficultyID = Difficulty.Basic,
        rankTimers = { 40000, 50000, },
    },
    { -- Rags to Riches Rush Reverse
        currencyID = 3127,
        uiMapID = 2346,
        areaPoiID = 8147,
        difficultyID = Difficulty.Reverse,
    ...
    { -- Sandy Scuttle Basic
        ...
        areaPoiID = 8180,
        difficultyID = Difficulty.Basic,
        rankTimers = { 33000, 38000, },
    },
    { -- Sandy Scuttle Reverse
        currencyID = 3188,
        uiMapID = 2346,
        areaPoiID = 8180,
        difficultyID = Difficulty.Reverse,
    ...
    { -- Scrapshop Shot Basic
        currencyID = 3124,
        uiMapID = 2346,
        areaPoiID = 8146,
        difficultyID = Difficulty.Basic,
        rankTimers = { 36000, 46000, },
    },
    { -- Scrapshop Shot Reverse
        currencyID = 3125,
        uiMapID = 2346,
        areaPoiID = 8146,
        difficultyID = Difficulty.Reverse,
    ...
    { -- Skyrocketing Sprint Basic
        currencyID = 3119,
        uiMapID = 2346,
        areaPoiID = 8144,
        difficultyID = Difficulty.Basic,
        rankTimers = { 32000, 42000, },
    },
    { -- Skyrocketing Sprint Reverse
        currencyID = 3121,
        uiMapID = 2346,
        areaPoiID = 8144,
        difficultyID = Difficulty.Reverse,
    ...
    { -- The Heaps Leap Basic
        currencyID = 3122,
        uiMapID = 2346,
        areaPoiID = 8145,
        difficultyID = Difficulty.Basic,
        rankTimers = { 33000, 43000, },
    },
    { -- The Heaps Leap Reverse
        currencyID = 3123,
        uiMapID = 2346,
        areaPoiID = 8145,
        difficultyID = Difficulty.Reverse,
